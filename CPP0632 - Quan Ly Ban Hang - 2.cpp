...
class HoaDon{
    public:
        string idBill, idGuest, idItem, nameItem;
        ll nums, money, profit;
        friend istream& operator >> (istream &in, HoaDon &a){
            ...
            in >> a.nums;
            for(auto &x : Mh){
                if(x.idItem == a.idItem){
                    a.money = a.nums * x.sellPrice;
                    a.profit = (x.sellPrice - x.buyPrice) * a.nums;
                    a.nameItem = x.nameItem;
                    break;
                }
            }
            return in;
        ...
        friend ostream& operator << (ostream &out, HoaDon a){
            ...
            for(auto &x : Mh) if(x.idItem == a.idItem){
                cout << x.nameItem << ' ' << a.nums << ' ' << a.money << ' ' << a.profit << endl;
            }
            return out;
        }
};
